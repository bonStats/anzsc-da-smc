...
subtitle: "Joshua Bon<br><br>ANZSC 2021<br><br>"
author: ""
institute: ""
...
## Details and talk outline

Joint work with **Anthony Lee** (Bristol University) and **Christopher Drovandi** (QUT)

- Slides available: https://bonstats.github.io/anzsc-da-smc/
- Paper available: https://arxiv.org/abs/2009.03699

--

**Talk outline**
- Deep end: Importance sampling to SMC (in 3 slides)
- David vs Goliath: Optimising delayed-acceptance in SMC
- Hand waving: Other tuning and optimisation for surrogate likelihoods 
- Did it work?: Results and summary
...
## Sequential Monte Carlo: spicy importance sampling

--

.full-width[.content-box-green[
`r emo::ji("pepper")` **Sequence of distributions**: $p_{t}(\boldsymbol{\theta}) = p_{0}(\boldsymbol{\theta})^{1-\gamma_{t}}p(\boldsymbol{\theta}~\vert~\boldsymbol{y})^{\gamma_{t}}$
...
1. Delayed-acceptance in SMC
    - Tune DA kernel adaptively with pilot run of mutation step
2. Surrogate likelihood calibration
    - Tune surrogate likelihood using history of particles
3. Surrogate first annealing
    - Use Surrogate posterior used as intermediate distribution
...
--
- Posterior distributions from adaptive SMC methods matched baseline
